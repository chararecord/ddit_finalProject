...
<script>
	...
	let makeTrTag = function(lecture, index){
	    ...
	    .text(lecture.lectId);
 		...
 		return $("<tr>").append(
				$("<td>").html("<a href='${pageContext.request.contextPath}/prof/scoreProc/'" + lecture.stdId +">" + lecture.rnum + "</a>")
				,$("<td>").html("<a href='${pageContext.request.contextPath}/prof/scoreProc/'" + lecture.stdId +">" + lecture.collVO.collNm)
				,$("<td>").html("<a href='${pageContext.request.contextPath}/prof/scoreProc/'" + lecture.stdId +">" + lecture.majorVO.majorNm)
				,$("<td>").html("<a href='${pageContext.request.contextPath}/prof/scoreProc/'" + lecture.stdId +">" + lecture.camYear)
				,$("<td>").html("<a href='${pageContext.request.contextPath}/prof/scoreProc/'" + lecture.stdId +">" + lecture.stdId)
				,$("<td>").html("<a href='${pageContext.request.contextPath}/prof/scoreProc/'" + lecture.stdId +">" + lecture.userNm)
		)
	}
